...
/**
 * <p>
 * Title:ToOnlineKitchenServlet
 * </p>
 * <p>
 * Description: 跳转查看在线后厨人员界面的跳转Servlet
 * </p>
 * <p>
...
public class ToOnlineKitchenServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// 直接以请求转发的方式跳转到查看在线后厨人员界面
		request.getRequestDispatcher("/pages/admin/onlinekitchens.jsp").forward(
				request, response);
	}
