					...
					<div class="row" style="padding-top: 0px">
						<div style="width: 55%;display: inline-block;">
							<div>
								...
								<form class="form-horizontal" role="form"
									style="margin-top: 20px" method="post" action="adddishes.order">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="dishesName"
												size="20" name="dishesName" placeholder="请输入菜品名称" required
												onblur="checkname()">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea rows="8" class="form-control" name="dishesTxt"></textarea>
										</div>
									...
									<input type="hidden" value="1.jpg" id="dishesImg"
										name="dishesImg" />

									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10">
											<input type="submit" class="btn btn-danger" id="addbtu"
												disabled="disabled" value="添加菜品" />
										</div>
									</div>
								</form>
							</div>
						...
						<div style="width: 25%;display: inline-block;vertical-align: top;">
							...
							<div style="text-align: center;">
								<img src="img/dishes/1.jpg" id="face" width="160px"
									height="160px" class="img-circle"
